	...
	public static void main(String[] args) {
		...
		GAME: while (running) {
			...
			while (enemyHealth > 0) {
				...
				if (health < 1) {
					System.out.println("Too week to fight");
					break;
				}

				System.out.println("---------------------------------------------");
				System.out.println(" # " + enemy + " was defeated: # ");
				System.out.print(" # You have " + health + " HP Left #");
				if (rand.nextInt(100) < healthPotionDropChance) {
					healthPotions++;

					System.out.println(" # The " + enemy + " was defeated! # ");
					System.out.println(" # You now have " + healthPotions + "health(s) #");

				}
				System.out.print("---------------------------------------------");
				System.out.print("What would you like to do now");
				System.out.print("1. Continue fight");
